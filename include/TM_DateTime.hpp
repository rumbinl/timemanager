...
struct TM_Time { int hours, minutes; bool operator==(const TM_Time& b) const { return hours==b.hours && minutes == b.minutes; } bool operator<(const TM_Time& b) const { return hours<b.hours || (hours==b.hours&&minutes<b.minutes); } };
