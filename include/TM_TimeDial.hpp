...
{
    public:
        TM_TimeDial(SkRect bounds, void* timeManPtr=NULL, void (*setTime)(void* timeManPtr, TM_Time time)=NULL, TM_Time (*getTime)(void* timeManPtr)=NULL, bool limited=true, TM_ViewSetting viewSetting = {colorScheme[3],colorScheme[2],colorScheme[1],0,12,0,0});
