...
{
    public:
        TM_View(SkRect bounds, std::vector<TM_RenderObject*> objects, bool scroll=false, TM_ViewSetting viewSetting={colorScheme[0],colorScheme[2],colorScheme[3],0,24,10,10});
