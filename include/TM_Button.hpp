...
template<typename DataType> class TM_Button : public TM_TextView 
{
    public:
        ...
        TM_Button(std::string (*getStringFunc)(void* contextPtr), SkRect bounds=SkRect::MakeEmpty(), DataType data=0, void* context=NULL, void (*actionFunc)(void* context, DataType data)=NULL, TM_ViewSetting viewSetting={colorScheme[1],colorScheme[2],colorScheme[3],0,24,5,5}, bool centered = true);
