...
{
    public:
        TM_TextBox(SkRect bounds=SkRect::MakeEmpty(), std::string placeholder="", void* contextPtr=NULL, std::string (*getStringFunc)(void* contextPtr)=NULL, void (*setStringFunc)(void* contextPtr, std::string newString)=NULL, TM_ViewSetting viewSetting ={colorScheme[1],colorScheme[2],colorScheme[3],0,24,5,5});
